...
intersect = list(set(indexes_w1) & set(indexes_w2)) 

# min_dist = float('inf')
# for point in intersect:
#     dist_to_center = abs(point[0]) + abs(point[1])
...
min_dist = float('inf')
for point in intersect:
    wire1_dist = next(i for i in range(len(indexes_w1)) if indexes_w1[i] == point)
    wire2_dist = next(i for i in range(len(indexes_w2)) if indexes_w2[i] == point)
    print(wire2_dist, wire1_dist)
    dist_to_intersect = wire1_dist+wire2_dist
    if dist_to_intersect < min_dist and dist_to_intersect > 0:
